    ...
    <div>
      ...
      <form onSubmit={save} className="bg-white rounded-xl border shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-6 max-w-2xl space-y-5">
        ...
        <div className="pt-4 border-t">
          <button type="submit" disabled={saving} className="flex items-center gap-2 bg-zinc-900 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-zinc-800 transition-colors disabled:opacity-50">
